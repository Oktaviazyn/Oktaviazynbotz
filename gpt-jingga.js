...
const handler = async (m, { text }) => {
	if (!text)
		throw "Contoh: .jingga Pesan yang ingin Anda sampaikan kepada asisten AI";
...
async function getgptc3Response(content) {
	...
	const headers = {
		...
		"User-Agent":
			"Mozilla/5.0 (Linux; Android 11; M2004J19C Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.129 Mobile Safari/537.36 WhatsApp/1.2.3",
