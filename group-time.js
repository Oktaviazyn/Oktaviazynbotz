...
`
  ...
  if (args[1]) {
	 setTimeout(async () => {
		    ...
		    conn.reply(m.chat, `Grup telah di ${isClose == 'not_announcement' ? 'tutup dulu sayang, sekarang hanya admin yang dapat mengirim pesan' : 'buka gaezz, sekarang semua member bisa mengirim pesan'}!`)
	    })
        }, timeoutset)
  }
  }
