...
let handler = async (m, { args, usedPrefix, text, command }) => {
	...
	let ouh = await fetch(
		`https://api.yanzbotz.my.id/api/ai/characterai?text=${text}&name=hutao`,
	);
		...
		m.chat,
		{
			...
			contextInfo: {
				externalAdReply: {
					...
					sourceUrl: "https://chat.whatsapp.com/JZLyu0D69ufCbXfDyxeI0",
					mediaType: 1,
...
handler.help = ["caihutao *ᴛᴇxᴛ*", "hutao *ᴛᴇxᴛ*"];
handler.tags = [tai];
